...
import com.example.viapath.databinding.FragmentSummaryBinding
...
class SummaryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentSummaryBinding.inflate(layoutInflater)
    ...
    private fun recipeDetailsResult(operationResult: OperationResult<RecipeDetail>) {
        when(operationResult) {
            ...
            is OperationResult.Success -> {
                ...
                viewBinding.summaryTextView.text = HtmlCompat.fromHtml(
                    operationResult.data?.summary?: resources.getString(
